...
export default function Footer() {
  return (
      <div className="flex flex-col lg:flex-row lg:justify-around xl:mx-auto mx-6 xl:max-w-6xl lg:h-80 border border-slate-900 rounded-2xl">
        ...
        <div className="lg:w-1/3 p-8 flex flex-col border border-slate-900 border-l border-r">
           ...
           <div className="flex mx-auto space-x-6 w-auto">
